...
//	setWindowFlags(Qt::WindowStaysOnTopHint);
	...
	setStyleSheet(  //padding: 2px
			"QWidget { background-color : rgba(20,20,20,70%); color: rgb(0,255,150);}"
			"QPushButton,QToolButton,QLineEdit { border-width: 1px; padding:3px; border-style: solid;  border-color: rgb(210,50,130); border-radius: 5px ;}"
			"QPushButton:hover,QToolButton:hover { color:rgb(40,255,190); padding:3px; border-width: 1px; border-style: solid;  border-color: rgb(230,80,170); border-radius: 5px ;}"
			"QPushButton:pressed,QToolButton:pressed { color:rgb(0,255,150); padding:3px; border-width: 2px; border-style: solid;  border-color: rgb(210,50,130); border-radius: 5px ;}"
			"QComboBox { border-width: 1px; padding:3px; border-style: solid;  border-color: rgb(50,200,130); border-radius: 5px ;}"
...
//	p.fillRect(rect(),QColor(255,255,255,255));
	...
	QRect rectR(shotarea->x()-1,shotarea->y()-1, shotarea->width()+2,shotarea->height()+2);
    opt.rect=rectR;
	opt.lineWidth=2;
	opt.midLineWidth=1;
...
//	return;
	if(flag_xcompmgr==false)
	{
		...
		painter.fillRect(shotarea->x()+1,shotarea->y()+1, shotarea->width()-2, shotarea->height()-2
